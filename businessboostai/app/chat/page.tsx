...
export default function SupportChatPage() {
  ...
  const [messages, setMessages] = useState<Message[]>(() => {
    ...
    const storedMessages = chatStorage.getMessages('support')
    if (storedMessages.length > 0) {
      ...
      return [{
        role: 'assistant',
        content: "Hello! I'm here to provide emotional support and encouragement. Running a business can be challenging, and I'm here to help you manage stress and stay motivated. What specific problem or challenge are you facing in your business today?"
      }]
    }
  })
  ...
  useEffect(() => {
    ...
    if (messages.length > 0) {
      ...
      chatStorage.saveMessages('support', messagesWithTimestamp)
    }
  }, [messages])
  ...
  const clearChat = () => {
    chatStorage.clearMessages('support')
    setMessages([{
      role: 'assistant',
      content: "Hello! I'm here to provide emotional support and encouragement. Running a business can be challenging, and I'm here to help you manage stress and stay motivated. What specific problem or challenge are you facing in your business today?"
    }])
        ...
        <div className="bg-white/80 dark:bg-zinc-800/80 backdrop-blur-sm rounded-2xl shadow-lg flex flex-col h-[calc(100vh-16rem)] border border-emerald-100 dark:border-zinc-700">
          ...
          <form onSubmit={handleSubmit} className="border-t border-emerald-100 dark:border-zinc-700 p-4">
            <div className="flex gap-2 mb-3 overflow-x-auto pb-2">
              {['What specific problem are you facing?', 'I need motivation', 'I feel overwhelmed', 'I need stress relief tips'].map((suggestion) => (
                <button
                  key={suggestion}
                  type="button"
            ...
            <div className="flex gap-3">
              ...
              <button
                ...
                className="px-6 py-3 bg-emerald-600 text-white rounded-xl hover:bg-emerald-700 disabled:bg-emerald-400 transition-colors font-medium shadow-md hover:shadow-lg transition-shadow"
              >
                Send
              </button>
            </div>
